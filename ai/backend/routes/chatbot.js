...
router.post("/gemini", async (req, res) => {
  try {
    ...
    // Tìm kiếm thông tin liên quan từ MongoDB
    ...
    // Tạo context từ các chunks tìm được
  ...
  5. **Tuyển sinh & học phí**:
   ...
   - Dịch vụ xe đưa rước và ăn uống dinh dưỡng, an toàn từ đơn vị chuyên nghiệp (May Catering).
    ...
    const response = await fetch(
      "https://generativelanguage.googleapis.com/v1beta/models/gemma-3n-e2b-it:generateContent?key=" + 
